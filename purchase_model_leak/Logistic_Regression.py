...
for i in  range(len(situation_name)):
    ...
    MODEL_PATH1 = 'model/'+situation_name[i]+'/Logistic_Regression_budget'
    MODEL_PATH2 = 'model/'+situation_name[i]+'/Logistic_Regression_acc'
    ...
    end_time = time.time()
    count_time(situation_name[i],'train acc model',start_time,end_time)
    ...
    end_time = time.time()
    count_time(situation_name[i],'train budget model',start_time,end_time)
